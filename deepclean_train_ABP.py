...
def test(test_file):
	...
	threshold = get_threshold(vae, train_files)
...
def get_threshold(vae, train_files, percentile_threshold=90):
	...
	Args:
		vae (_type_): _description_
		train_files (_type_): _description_
		percentile_threshold (int, optional): _description_. Defaults to 90.
